...
The Video Heartbeat Library (VHL) was the original Adobe media tracking SDK. Starting with v2.2, it was renamed Media SDK. See the [1.x to 2.x migration guide](https://github.com/Adobe-Marketing-Cloud/media-sdks/blob/master/docs/migration/1x-to-2x.md) for a full API comparison.
